...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title> Cruise Operator Registration</title>
    <link rel="stylesheet" href="style2.css">
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
   </head>
<body>
  <div class="container">
    <div class="title">Cruise Operator Registration</div>
    <div class="content">
      <form method="post">
...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $email = $_POST['email'];
    $gstNumber = $_POST['gst'];
    $address = $_POST['Headquater_Address'];
    ...
    $sql = "INSERT INTO cruise_registration (ID,operator_name, phone_number, email, gst_number, Headquater_Address, pincode, city, state,country, location) VALUES (1,'$opName',$phone_number,'$email', '$gstNumber', '$address', '$pincode', '$city', '$state', '$country','$location')";
