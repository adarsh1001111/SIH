...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title> Cab Operator Registration</title>
    <link rel="stylesheet" href="style2.css">
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
   </head>
<body>
  <div class="container">
    <div class="title">Cab Operator Registration</div>
    <div class="content">
      <form method="post">
...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $sql = "INSERT INTO cab_registration (ID,operator_name, phone_number, email, gst_number, Address, pincode, city, state,country, location) VALUES (1,'$opName','$phone_number','$email', '$gstNumber', '$address', '$pincode', '$city', '$state', '$country','$location')";
    

    if (mysqli_query($conn, $sql)) {
        echo "Registration successful!";
        header("Location: Cab Operator Dashboard.html");
        exit();
    } else {
