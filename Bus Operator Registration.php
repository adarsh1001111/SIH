...
<body>
  <div class="container">
    <div class="title">Bus Operator Registration</div>
    <div class="content">
      <form method="post">
...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $sql = "INSERT INTO bus_registration (ID,operator_name, phone_number, email, gst_number, Address, pincode, city, state,country, location) VALUES (1,'$opName',$phone_number,'$email', '$gstNumber', '$address', '$pincode', '$city', '$state', '$country','$location')";
    

    if (mysqli_query($conn, $sql)) {
        echo "Registration successful!";
        header("Location: Bus Operator Dashboard.html");
    exit();
    } else {
